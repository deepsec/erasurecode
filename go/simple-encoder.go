...
var dataShards = flag.Int("data", 6, "Number of shards to split the data into, must be below 257.")
...
func main() {
	...
	fmt.Println("**** Encode Time: ",  time.Since(start).Seconds(), "(s) ****")
	checkErr(err)
	fmt.Println("**** Encode+Verity Time: ",  time.Since(start).Seconds(), "(s) ****")
